...
Session.find_or_create_by!(title: 'Welcome & Opening Keynote') do |session|
  ...
  session.start_time = 1.day.from_now.beginning_of_day + 9.hours
  session.end_time = 1.day.from_now.beginning_of_day + 10.hours
...
Session.find_or_create_by!(title: 'Building Scalable APIs with Ruby on Rails') do |session|
  ...
  session.start_time = 1.day.from_now.beginning_of_day + 10.hours + 30.minutes
  session.end_time = 1.day.from_now.beginning_of_day + 11.hours + 30.minutes
...
Session.find_or_create_by!(title: 'Modern Frontend Development with Hotwire') do |session|
  ...
  session.start_time = 1.day.from_now.beginning_of_day + 14.hours
  session.end_time = 1.day.from_now.beginning_of_day + 15.hours
...
Session.find_or_create_by!(title: 'Database Performance & Optimization') do |session|
  ...
  session.start_time = 1.day.from_now.beginning_of_day + 15.hours + 30.minutes
  session.end_time = 1.day.from_now.beginning_of_day + 16.hours + 30.minutes
  session.speaker = speaker1
end
...
Session.find_or_create_by!(title: 'Closing Remarks & Networking') do |session|
  ...
  session.start_time = 1.day.from_now.beginning_of_day + 17.hours
  session.end_time = 1.day.from_now.beginning_of_day + 18.hours
  session.speaker = speaker2
end
